...
class ConfService:
    ...
    # ---------------------------------------------------------------------------
    trusted_CAs_path = "/opt/py-issuer/trusted_cas/"
    ...
    pid_issuing_authority = "Py Test PID issuer"

    # PID Organization ID
    pid_organization_id = "BLSP NL"
    ...
    mdl_issuing_authority = "Py Test MDL issuer"
    ...
    qeaa_issuing_authority = "BLSP NL"
